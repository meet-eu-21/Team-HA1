...
from graph_generation import load_ccmap_file, statistics_adjacency_matrix, graph_filtering, restrict_arrowhead_solution_list, restrict_node_features_list
...
if __name__ == "__main__":
    ...
    node_features_list = combine_genomic_annotations_and_housekeeping_genes(parameters, arrowhead_solution_list, adjacency_matrices_source_information_list, dict_genomic_annotations, dict_housekeeping_genes)

    node_features_list = restrict_node_features_list(node_features_list, edge_index_list)
    arrowhead_solution_list = restrict_arrowhead_solution_list(arrowhead_solution_list, edge_index_list)
