...
class GATConv(MessagePassing):
    r"""
    Implementation derived from PyTorch Geometric implementation of GATv2Conv layer: https://pytorch-geometric.readthedocs.io/en/latest/modules/nn.html#torch_geometric.nn.conv.GATv2Conv
